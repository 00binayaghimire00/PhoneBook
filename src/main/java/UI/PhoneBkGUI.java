...
//        if ("contactAdded".equals(evt.getPropertyName()) || "contactDeleted".equals(evt.getPropertyName())) {
//        lblCount.setText(phonebookdata.getCounter() + " record(s)");
//    }
        int size = phonebookdata.getCounter();
        this.lblCount.setText(size > 1?  size + " records" : size + " record");
    }
}
